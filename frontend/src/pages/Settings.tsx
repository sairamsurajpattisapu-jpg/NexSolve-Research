...
export function Settings() {
  ...
  const analysisId = data.results.analysis_id
  ...
  return (
    <div className="page-stack page-enter">
      <SectionHeading
        ...
        description="Operational context for the NexSolve demonstration environment."
      />
