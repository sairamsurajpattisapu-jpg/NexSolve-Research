...
const ARCHITECTURE_NODES: ArchitectureNode[] = [
  ...
  },
  {
    ...
    contract: 'Strict omission of unobserved fields. mean_tcp_rtt is never fabricated or zero-filled.',
  },
  {
    id: 'temporal_state',
    ...
    contract: 'Canonical 45-feature schema matching offline trained world model weights.',
  },
  {
    id: 'world_model',
    label: 'LSTM World Model',
    subtitle: 'Recursive K-step rollout',
    layer: 'SIMULATE',
    icon: BrainCircuit,
